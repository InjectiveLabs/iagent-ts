...
export class InjectiveGrpcBase {
	...
	constructor(
		...
		this.chainGrpcExchangeApi = new ChainGrpcExchangeApi(this.endpoints.grpc);
		...
		this.indexerGrpcSpotApi = new IndexerGrpcSpotApi(this.endpoints.indexer);
		...
		this.ethAddress =
			ethPublicKey || (injPublicKey ? getEthereumAddress(injPublicKey) : "");

		this.injAddress =
			injPublicKey || (ethPublicKey ? getInjectiveAddress(ethPublicKey) : "");
